...
def prepare_data(data_dir):
    ...
    for label in ['Muhammed', 'cat', 'dog', 'Fark_edilemeyen']:  # Yeni etiket: Fark_edilemeyen
...
# Etiketleri sayısal hale getirin (Muhammed=0, cat=1, dog=2, Fark_edilemeyen=3)
y = np.array([0 if label == 'Muhammed' else 1 if label == 'cat' else 2 if label == 'dog' else 3 if label == 'Fark_edilemeyen' else ])
